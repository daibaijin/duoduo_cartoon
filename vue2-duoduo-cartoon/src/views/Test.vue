...
<script>
    export default {
      ...
      return {
          ...
          created() {
             ...
             this.$nextTick(() => {
                ...
                //  this.listitem();
                 this.data();
                 this.loadAll1();
                console.log("mainrecommendlist",this.mainrecommendlist);
             })
       },
        methods: {
            data(){
              ...
              this.axios({
                   method: 'get',
                   url: 'https://apis.netstart.cn/bcomic/SearchRecommend?num=10',
                ...
                console.log(this.mainrecommendlist);
        ...
        //   变
          loadAll1(){
              console.log("变this.mainrecommendlist",this.mainrecommendlist);
