     ...
     data() {
       ...
       created() {
        ...
        this.$nextTick(() => {
                  ...
                  if (verify[verify.length-1].code==200) {
                    ...
                    console.log("this.currentuser",this.currentuser);
                    this.login(this.getread,this.getlike);
      ...
      methods: {
        ...
        getlikevalue(readmessage,likemessage,init1,init2){
          ...
          console.log("first   this.likelist",this.likelist);
          let isthis=this;
           if (Object.prototype.toString.call(isthis.currentuser) == "[object Array]") {
                let instand=isthis.currentuser[isthis.currentuser.length-1]
              }else{
          ...
          this.bigdata.forEach(function (item,index) {
            ...
            if (item.code==200&&item.phone==isthis.currentuser[isthis.currentuser.length-1].phone) {
              console.log(item,index);
        ...
        test(value){
           console.log("test-likearr",value);
        },
        noneoptionbox(){
